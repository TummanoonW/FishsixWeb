                                    ...
                                    <div class="card-columns">
                                        <div class="card">
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="<?php Nav::echoURL($dir, App::$pageCourseView) ?>">
                                                            <img src="<?php Asset::echoThumb($dir, 'assets/images/thumbs/vuejs.png') ?>" alt="Card image cap" width="100" class="rounded">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="card-title m-0"><a href="<?php Nav::echoURL($dir, App::$pageCourseView) ?>">Learn VueJs the easy way!</a></h4>
                                            ...
                                            <div class="card-footer bg-white">
                                                <a href="<?php Nav::echoURL($dir, App::$pageCourseView) ?>" class="btn btn-primary btn-sm">Continue <i class="material-icons btn__icon--right">play_circle_outline</i></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="<?php Nav::echoURL($dir, App::$pageCourseView) ?>">
                                                            <img src="<?php Asset::echoThumb($dir, 'assets/images/thumbs/github.png') ?>" alt="Card image cap" width="100" class="rounded">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="card-title m-0"><a href="<?php Nav::echoURL($dir, App::$pageCourseView) ?>">Github Webhooks for Beginners</a></h4>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <h4 class="card-title m-0"><a href="<?php Nav::echoURL($dir, App::$pageCourseView) ?>">Gulp and Slush</a></h4>
                                        ...
                                        <div class="card">
                                            <div class="card-header ">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <h4 class="card-title m-0"><a href="<?php Nav::echoURL($dir, App::$pageCourseView) ?>">VueJs</a></h4>
                                                        <small class="text-muted">Lessons: 3 of 7</small>
                                                    </div>
                                                </div>
                                            </div>
